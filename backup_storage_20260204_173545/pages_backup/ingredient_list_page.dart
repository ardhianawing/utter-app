                    ...
                    builder: (ctx) => IngredientFormDialog(
                      ...
                      onSave: (data) async {
                        await ref.read(ingredientNotifierProvider.notifier).updateIngredient(
                          ingredientId: ing.id,
                          name: data['name'],
                          unit: data['unit'] != null ? IngredientUnitExtension.fromString(data['unit']) : null,
                          costPerUnit: data['cost_per_unit'] != null ? double.tryParse(data['cost_per_unit'].toString()) : null,
                          minStock: data['min_stock'] != null ? double.tryParse(data['min_stock'].toString()) : null,
